...
if(isset($_POST['email'])) {
	...
	$message = Swift_Message::newInstance('A message from the Website')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('gendencare@gmail.com' => 'Gentle Dental Care'))->setBody($messageText);
//                           ^                    ^
